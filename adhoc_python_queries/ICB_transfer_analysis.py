...
date_dict = {"03": 31, "04": 30, "05": 31, "06": 30, "07": 31, "08": 31}
...
for month, num_days in date_dict.items():
    for i in range(1, num_days + 1):
        ...
        df_icb = df_icb[df_icb["sending_practice_sicbl_ods_code"] == "15E"]
...
final_df.to_csv(path_or_buf="adhoc_python_queries/ICB_transfer_analysis_BSOL_ICB.csv", index=False)
