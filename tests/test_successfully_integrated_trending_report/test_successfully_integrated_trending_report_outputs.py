...
class TestSuccessfullyIntegratedTrendingReportOutputs(TestBase):
    ...
    def test_gp2gp_successfully_integrated_report_trending_count(self, time_period, expected_output):
        ...
        try:
            ...
            test_query = self.generate_splunk_query_from_report(
                'gp2gp_successfully_integrated_trending_report/'
                'gp2gp_successfully_integrated_trending_report_count')
    ...
    def test_gp2gp_successfully_integrated_report_trending_percentage(self, time_period, expected_output):
        ...
        try:
            ...
            test_query = self.generate_splunk_query_from_report(
                'gp2gp_successfully_integrated_trending_report/'
                'gp2gp_successfully_integrated_trending_report_percentage')
