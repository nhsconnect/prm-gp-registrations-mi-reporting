...
class TestTransferStatusReportTableOutputs(TestBase):   
    ...
    def test_gp2gp_transfer_status_report_snapshot_counts(self):
        ...
        try:
            ...
            # Act
            test_query = self.get_search('gp2gp_transfer_status_report/gp2gp_transfer_status_report_snapshot_counts')
