...
class TestErrorsRawDataTableOutputs(TestBase):
    ...
    def test_gp2gp_errors_raw_data_table_outputs(self, error_type, failure_point):
        ...
        try:
            ...
            test_query = self.generate_splunk_query_from_report(
                ...
                "gp2gp_errors_snapshot_raw_data_table")
    ...
    def test_gp2gp_errors_raw_data_table_other_failure_point(self):
    ...
    def test_gp2gp_errors_raw_data_table_output_multiple_errors_1_conv(self, error_type, failure_point):
    ...
    def test_gp2gp_errors_raw_data_table_1_conv_1_error(self, failure_point_graph_column):
    ...
    def test_gp2gp_errors_raw_data_table_2_conv_1_error_1_failure_point(self):
    ...
    def test_gp2gp_errors_raw_data_table_1_conv_2_error_1_failure_point(self, error_graph_column):
