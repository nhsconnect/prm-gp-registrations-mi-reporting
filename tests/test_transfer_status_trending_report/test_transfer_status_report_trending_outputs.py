...
class TestTransferStatusReportTrendingOutputs(TestBase):
    ...
    def test_gp2gp_transfer_status_report_trending_total_eligible_for_transfer(self):
        ...
        try:
            ...
            # Act
            test_query = self.generate_splunk_query_from_report(
                'gp2gp_transfer_status_trending_report/'
                'gp2gp_transfer_status_trending_report_total_eligible_for_transfer')
